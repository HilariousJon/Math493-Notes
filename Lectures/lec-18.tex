\begin{subsection}{Special simple groups}
  ...
  \begin{remark}
    \( A_4 \) is \textbf{not} simple group!
    \[
      H = \{e, (12)(34), (13)(24), (14)(23)\} \unlhd a_4 
    \] 

    Note that \( H \) is isomorphic to the \textbf{Klein group}. See that \( H \) is a normal subgroup since \textbf{conjugation preserves the cycle type decomposition} and the element of \( H \) that are \( \ne e \) are \textbf{precisely the one} that decomposition as product of \( 2 \) disjoint cycles.
  \end{remark}

  \begin{remark}
    Elementary to check: if \( \abs{G} < 60 \), \( G \) is simple \( \implies G \cong \quotient{\ZZ}{p\ZZ} \), \( p \) prime.
  \end{remark}
\end{subsection}
